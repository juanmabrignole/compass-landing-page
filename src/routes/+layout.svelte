...
<header class="max-w-6xl mx-auto w-full px-4 h-36 flex items-center justify-between *:z-10 -mb-36">
    ...
    <div class="flex items-center text-2xl gap-3 text-white">
        <a href="https://www.instagram.com/krak.realestate/" class="hover:text-blue-300 icon-[mdi--instagram]"> </a>
        <a href="https://www.tiktok.com/@krak.realestate" class="hover:text-blue-300 icon-[ic--baseline-tiktok]"> </a>
        <a href="https://www.linkedin.com/company/krakre/" class="hover:text-blue-300 icon-[mdi--linkedin]"> </a>
        <a href="https://www.youtube.com/channel/UCx5MEQ0uTFHNaaoGOVGFFSw" class="hover:text-blue-300 icon-[mdi--youtube]"> </a>
    </div>
</header>
...
<footer class="bg-blue-500 text-white py-16">
    <div class="max-w-6xl mx-auto w-full px-4 grid sm:grid-cols-2 md:grid-cols-3 gap-16 sm:gap-8 md:gap-4">
        ...
        <div>
            ...
            <a class="flex items-center text-lg gap-2 hover:text-blue-300 mb-2 font-semibold tracking-wider" href="tel:+541138882095"><span class="icon-[mdi--phone] text-2xl"></span><span>11 3888-2095</span></a>
            <a class="flex items-center text-lg gap-2 hover:text-blue-300 mb-3 font-semibold tracking-wider" href="mailto:info@krak.com.ar"><span class="icon-[mdi--email] text-2xl"></span><span>info@krak.com.ar</span></a>
